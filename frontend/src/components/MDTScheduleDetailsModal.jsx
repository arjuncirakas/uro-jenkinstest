            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-white text-sm font-medium ${isMeetingComplete
                      ...
                      {followUpActions.map((action) => (
                        ...
                        >
                          <button
                            ...
                            className={`w-5 h-5 rounded border-2 flex items-center justify-center transition-all flex-shrink-0 ${action.completed
              ...
              <section className="bg-white rounded-lg border border-gray-200 shadow-sm">
                ...
                <div className="p-6">
                  <div className="mb-6">
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      Supported formats: PDF, DOC, DOCX, DICOM • Maximum file size: 10MB
                    </p>
                  </div>
          ...
          <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-between flex-shrink-0">
            <div className="flex items-center gap-3">
              <button
                onClick={() => setShowRescheduleModal(true)}
                disabled={isMeetingComplete}
                className={`px-4 py-2.5 text-sm font-medium rounded-lg ${isMeetingComplete
