...
import { X, Activity, Mail, Phone, Building2, User } from 'lucide-react';
...
const AddGPModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await gpService.createGP(formData);
      ...
      if (response.success) {
        ...
        setErrorMessage(response.error || response.message || 'Failed to create GP');
      ...
      const message = error?.response?.data?.error || 
                     ...
                     error?.message || 
                     'Failed to create GP. Please try again.';
  ...
  return (
    <>
        ...
        <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              ...
              <h2 className="text-xl font-semibold text-gray-900">Add New GP</h2>
            </div>
            <button
              onClick={onClose}
      ...
      <SuccessModal
        ...
        title="GP Added Successfully"
        message="The GP has been added to the users table. A password setup email has been sent."
      />
