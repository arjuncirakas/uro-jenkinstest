    ...
    <div className="flex h-screen bg-gray-50">
      ...
      `}>
        ...
        <div className="p-6">
          ...
          {!isCollapsed && <div className="mt-2 text-xs text-gray-500">Superadmin Panel</div>}
        </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-gray-50">
          <div className="py-6">
            <div className={`mx-auto ${location.pathname === '/superadmin/users' ? 'max-w-full' : 'max-w-7xl'} px-4 sm:px-6 lg:px-8`}>
              <Outlet />
            </div>
          </div>
        </main>
