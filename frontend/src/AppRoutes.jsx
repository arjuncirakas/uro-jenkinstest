  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="patients" element={<Navigate to="/urologist/patients/patients-under-me" replace />} />
        <Route path="patients/patients-under-me" element={<Patients />} />
        <Route path="patients/my-patients" element={<Patients />} />
