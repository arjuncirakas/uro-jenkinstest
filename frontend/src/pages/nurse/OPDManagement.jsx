              ...
              <div className="px-4 sm:px-6 py-4 border-b border-gray-200">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    >
                      <svg className={`w-3 h-3 ${loadingAppointments ? 'animate-spin' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <div className="min-w-0 flex-1">
                                ...
                                <div className="flex items-center mt-0.5">
                                  <div className="w-1 h-1 bg-orange-500 rounded-full mr-1 flex-shrink-0"></div>
                                  <span className="text-xs text-orange-600">PSA: {appointment.psa}</span>
                                </div>
                              </div>
                            </div>
                          </td>
              ...
              <div className="px-4 sm:px-6 py-4 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    disabled={loadingNewPatients}
                    className="px-3 py-1.5 bg-teal-600 text-white text-xs rounded-md hover:bg-teal-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-1"
                  >
                    <svg className={`w-3 h-3 ${loadingNewPatients ? 'animate-spin' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                    </svg>
                    <span>Refresh</span>
                  </button>
                        ...
                        <div className="flex items-start space-x-3 flex-1">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center mb-1">
                              ...
                              <span className="text-xs text-orange-600">PSA: {patient.psa} ng/mL</span>
                            </div>
